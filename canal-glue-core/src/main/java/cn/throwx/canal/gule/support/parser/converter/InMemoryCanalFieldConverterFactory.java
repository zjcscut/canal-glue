...
public class InMemoryCanalFieldConverterFactory implements CanalFieldConverterFactory {
    ...
    private final ConcurrentMap<Class<? extends BaseCanalFieldConverter>, BaseCanalFieldConverter> klassConverters = new ConcurrentHashMap<>(16);
